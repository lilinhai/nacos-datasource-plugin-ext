...
public class SqlServerDatabaseDialect extends AbstractDatabaseDialect
{
    ...
    {
        return sql + " ORDER BY id OFFSET " + getPagePrevNum(pageNo, pageSize) + " ROWS FETCH NEXT " + pageSize + " ROWS ONLY ";
    }
    
    @Override
    public String getLimitPageSqlWithOffset(String sql, int startOffset, int pageSize)
    {
        return sql + " ORDER BY id OFFSET " + startOffset + " ROWS FETCH NEXT " + pageSize + " ROWS ONLY ";
    }
}
